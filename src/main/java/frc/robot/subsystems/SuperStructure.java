...
public class SuperStructure extends SubsystemBase {
    ...
    public Command getHybridAlgaeIntakeCommand(Button executionButton) {
        if (robotStatus == RobotStatus.IDLE) {
            return new AlgaeHybridIntake(chassis.generateAlgaeIntakeIndex(), executionButton)
                    .andThen(() -> robotStatus = RobotStatus.HOLDING_ALGAE); // TODO
        } else
            return null;
    }
    ...
    public void periodic() {
        ...
        SmartDashboard.putString("SuperStructure/faceSelection", driverSelection.toString());

        SmartDashboard.putString("SuperStructure/scoreMode", scoreMode.toString());

        SmartDashboard.putString("SuperStructure/targetReefFace", String.valueOf(m_operatorReefFaceIndex));
    }
}